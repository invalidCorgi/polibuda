...
void drawScene(GLFWwindow* window, float angle) {
	...
	float myScalex = (float)((rand()%1000)/500.0f);
	float myScaley = (float)((rand()%1000)/500.0f);
	float myScalez = (float)((rand()%1000)/500.0f);
	//if(i == 0)
    ...
    M=rotate(M,angle,glm::vec3(0.3f,1.0f,0.2f));
    M=glm::scale(M,glm::vec3(myScalex,myScaley,myScalez));
