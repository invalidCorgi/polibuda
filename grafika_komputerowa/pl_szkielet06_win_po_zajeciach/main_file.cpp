...
void initOpenGLProgram(GLFWwindow* window) {
	...
	shaderProgram=new ShaderProgram("vshader.vert","gshader.geom","fshader.frag"); //Wczytaj program cieniujący
...
void drawObject(GLuint vao, ShaderProgram *shaderProgram, mat4 mP, mat4 mV, mat4 mM) {
	...
	glUniform1f(shaderProgram->getUniformLocation("maxFurLength"),0.2); //Powiązanie textureMap1 we fragment shaderze z jednostką teksturowania nr 1
	glUniform1f(shaderProgram->getUniformLocation("maxLayer"),500); //Powiązanie textureMap1 we fragment shaderze z jednostką teksturowania nr 1
